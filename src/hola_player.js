...
/* *********** DASH_START *********** */
    ...
    if(deps.mchromecast)
    {
        ...
        require('./mchromecast.js');
        require('./css/mchromecast.css');
    }

    if(deps.vgoogleanalytics)
    {
        require('videojs-analytics');
        require('./vgoogleanalytics.js');
    }
...
Player.prototype.init_vjs = function(){
    ...
    load_deps({
        ...
        mchromecast: opt.mchromecast,

        vgoogleanalytics: opt.vgoogleanalytics,
