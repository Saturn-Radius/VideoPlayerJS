    ...
    grunt.initConfig({
        ...
        browserify: {
            ...
            watch: {
                ...
                files: {'dist/castr_player.dev.js': ['src/hola_player.js']},
            },
            vjs: {
                files: {'work/castr_vjs.dev.js':
                    ['./node_modules/@hola.org/hap.js/lib/hola_videojs_hls.js']
                },
            },
            dist: {
                files: {
                    'work/castr_player.dev.js': ['src/hola_player.patched.js'],
                },
                options: {
                    ignore: [
            ...
            dash: {
                files: {
                    'work/castr_player.dash.dev.js': ['src/hola_player.patched.js']
                },
            },
        },
        exorcise: {
            vjs: {
                files: {
                    'work/castr_vjs.dev.js.map': ['work/castr_vjs.dev.js'],
                },
            },
            dist: {
                files: {
                    'work/castr_player.dev.js.map': ['work/castr_player.dev.js'],
                },
            },
            dash: {
                files: {
                    'work/castr_player.dash.dev.js.map': ['work/castr_player.dash.dev.js'],
                },
            },
        },
        copy: {
        ...
        uglify : {
            ...
            vjs: {
                options: {sourceMapIn: 'work/castr_vjs.dev.js.map'},
                files: {'work/castr_vjs.js': 'work/castr_vjs.dev.js'},
            },
            dist: {
                options: {sourceMapIn: 'work/castr_player.dev.js.map'},
                files: {'work/castr_player.js': 'work/castr_player.dev.js'},
            },
            dash: {
                options: {sourceMapIn: 'work/castr_player.dash.dev.js.map'},
                files: {'work/castr_player.dash.js': 'work/castr_player.dash.dev.js'},
            },
        },
        concat: {
            options: {
...
hola_player_init();
            ...
            dist: {
                files: {'dist/castr_player.js':
                    ['work/castr_player.js', 'work/castr_vjs.js'],
                    'dist/castr_player.dev.js':
                    ['work/castr_player.dev.js', 'work/castr_vjs.dev.js'],
                }
            },
            dash: {
                files: {'dist/castr_player.dash.js':
                    ['work/castr_player.dash.js', 'work/castr_vjs.js'],
                    'dist/castr_player.dash.dev.js':
                    ['work/castr_player.dash.dev.js', 'work/castr_vjs.dev.js'],
                }
            },
        },
        zip: {
            dist: {
                ...
                src: ['dist/**/*'],
                dest: 'dist/castr-player-'+pkg.version+'.zip',
            },
        },
    });
